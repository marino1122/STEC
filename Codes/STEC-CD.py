...
#load dataset
Elec_day = pd.read_csv(Elec_day_path, header=0,index_col=0)
...
time = input ("Please input the manufacturing time (supported input: 01.01.2021-31.12.2021): ")
