# -*- coding: utf-8 -*-
"""
Created on Fri Sep  9 17:40:39 2022
...
#load dataset
Elec_year = pd.read_csv(Elec_year_path, header=0,index_col=0)
...
time = input ("Please input the manufacturing time (supported input: 2019,2020,2021): ")
location = input ("Please input the manufacturing location \n Support input: EU, ASEAN:")  
...
try:
    CI= Elec_year.loc[int(time)][location]   
